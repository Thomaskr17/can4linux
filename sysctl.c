...
char Chipset[PROC_CHIPSET_LENGTH] =
...
int Speedfactor[MAX_CHANNELS]	   = { [0 ... (MAX_CHANNELS - 1)] = 1 };	/* CAN FD speed factor */
...
unsigned int framelength = CAN_MSG_LENGTH;
...
// int Options[MAX_CHANNELS]        = { 0x0 }; /* not used so far */
int ArbitrationLost[MAX_CHANNELS]= { 0x0 };
